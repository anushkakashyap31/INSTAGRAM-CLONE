...
All modifying endpoints require:
...
* Use Signup and Login to obtain JWT
* Set token in headers or environment variable
* Test Auth, Users, Posts, Likes, and Comments APIs
...
* Clear separation of concerns in backend (models, routes, middleware, config)
* Environment variables isolated using `.env`
* RESTful API design and consistent naming conventions
* Frontend structured by components, pages, context, api, and styles

---

## 10. Deliverables Mapping to Task

* **Database design:** User, Post, Comment models
* **API design:** REST APIs in `backend/src/routes`
* **Node.js project:** Complete backend implementation
